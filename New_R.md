...
|                            | `IQR()`              | Calculates the Interquartile Range (Q3 - Q1) of a numeric vector.                                                                                              |
...
||`residuals(model)`|Extracts the residual values from a fitted model object.|`residuals(my_lm_model)`|
